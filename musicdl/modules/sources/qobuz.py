...
class QobuzMusicClient(BaseMusicClient):
    ...
    def _parsewiththirdpartapis(self, search_result: dict, request_overrides: dict = None):
        ...
        for parser_func in [self._parsewithzarzqbzapi, self._parsewithzarzqbz2api, self._parsewithkennyyapi, self._parsewithgdstudioxyzapi, self._parsewithgdstudioorgapi, self._parsewithspotbyeqzzapi]:
